...
lst = []
base_url = "https://www.timesjobs.com/candidate/job-search.html?from=submit&luceneResultSize=25&postWeek=60&searchType=Home_Search&cboPresFuncArea=28&pDate=Y&sequence={}&startPage={}"
...
jobs_df.to_excel('Second-Data.xlsx', index=False)

print("Excel file 2 been created!")